...
<div class="leftcolumn">
  ...
  <a   class='sideactive' href="Details.php?c_id=<?php echo $c_id; ?>">Details</a>
  </div> 
</div>
<div class="rightcolumn">
<div class="topnav" style="width:40%; border-radius:10px;">
       <a  href='course_assignment2.php?c_id=<?php echo $c_id; ?>'>Assignment 1</a>
        <a href="course_assignment2.php?c_id=<?php echo $c_id; ?>">Assignment 2</a>
        <a href="course_assignment3.php?c_id=<?php echo $c_id; ?>">Assignment 3</a>
</div>
<br>
...
<div class="input-group">
 ...
 <div class="input-group">
  	  <label>Year</label>
  	  <input type="text" value="<?php echo $c_year?>">
  	</div>
		<div class="input-group">
  	  <label>Stream</label>
        <input type="text" value="<?php echo $c_stream?>">
    </div>
  	<div class="input-group">
  	  <label>Section</label>
        <input type="text" value="<?php echo $c_section?>">
</div>
	</form>
</div>
</div>	
