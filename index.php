...
$fid = $_SESSION['student_id'];

$course_query = "SELECT * FROM course WHERE c_id in (SELECT c_id FROM student_takes_course WHERE s_roll = '$fid')";
...
$end = date('Y-m-d', strtotime($course['c_end']));
  ...
  <div class="card-body">
	...
	<?php  if ($Today>=$start && $Today<=$end): ?>
		 ...
		 <?php  endif ?>
              <!--<div class="card mb-4 box-shadow">-->
                    ...
                    <!--<div class="btn-group">-->
										<form	 style=" padding:0px;  border-radius:10px; position: static; " action="course_assignment1_student.php" method="get">
    ...
    <?php
			...
			?>
<div  class="error" class="container-fluid" style="width:100%; border-radius=5px; ">
        <p ><h2><center>Courses are Yet to be Created!!!</center></h2>
         </div>
