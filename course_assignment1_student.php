...
<a  class='active' href='#'>Assignment 1</a>
        <a href="course_assignment2_student.php?c_id=<?php echo $c_id; ?>">Assignment 2</a>
     ...
     // array_push($errors, "solution already submitted, new submisiion will overwrite the existing one");
            ...
            if (mysqli_affected_rows($db) > 0) {
                echo "<script> alert('Assignment uploaded successfully.');
                 window.location.href='course_assignment1_student.php?c_id=$c_id';</script>";
            }
            else {
...
<div class="container-fluid" style="width:80%; border-radius=5px; margin-left:-15px;">
  <form action="course_assignment1_student.php" method="POST"  style="border-radius:5px;" enctype="multipart/form-data">
        <fieldset>
        <div class="form-group">
